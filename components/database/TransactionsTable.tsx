...
const thClass = 'text-left py-2 px-3 text-muted text-xs uppercase font-medium cursor-pointer hover:text-accent select-none whitespace-nowrap'
const tdClass = 'py-2 px-3 text-muted-strong text-xs whitespace-nowrap'
        ...
        <div className="flex items-center justify-between px-4 py-3 border-t border-border">
          ...
          <div className="flex gap-2">
            <button
              ...
              disabled={page === 0}
              className="px-3 py-1 text-xs rounded bg-surface-hover text-muted-strong hover:text-accent disabled:opacity-40 disabled:cursor-not-allowed border border-border"
            >
              ← Prev
            </button>
            <button
